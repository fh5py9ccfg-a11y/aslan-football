...
class ComebackScanner:
    ...
    def __init__(
        ...
        *,
        ...
        threshold_2_1: int | None = None,
        threshold_1_2: int | None = None,
        min_similar_matches: int = 20,
    ):
        # Evaluate both directions first, then apply direction-specific thresholds.
    ...
    def scan(self, fixtures: Iterable[Mapping[str, object]], *, limit: int = 10) -> list[dict]:
        ...
        for fixture in fixtures:
            ...
            label = "VERY_STRONG" if score >= 88 else "STRONG" if score >= 82 else "WATCH"
            candidates.append(
                ComebackCandidate(
